const stumge = require('../src/stumge.js')
...
describe('stumge_vector2d', function() {
  ...
  it('should store x and y values properly', function() {
    const v = new stumge._test.stumge_vector2d(1.5, 2.5)
  ...
  it('should properly calculate the magnitude', function() {
    const v = new stumge._test.stumge_vector2d(3, 4)
    const m = v.magnitude()
    assert.strictEqual(almostEqual(m, 5), true)
  })

  it('should normalize appropriately', function() {
    const v1 = new stumge._test.stumge_vector2d(3, 4)
  ...
  it('should normalize appropriately with a zero coordinate', function() {
    const v1 = new stumge._test.stumge_vector2d(3, 0)
    const v2 = v1.normalize()
  ...
  it('should properly add two vectors', function() {
    const v1 = new stumge._test.stumge_vector2d(1.2, 2.3)
    const v2 = new stumge._test.stumge_vector2d(3, 4)
    const v3 = v1.add(v2)
